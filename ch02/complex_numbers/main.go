...
func main() {
	...
	// use the built-in imag function to extract the imaginary portion of a complex number
	fmt.Println(imag(x))

	// use the Abs function in math/cmplx pkg to take the absolute value of a complex number
